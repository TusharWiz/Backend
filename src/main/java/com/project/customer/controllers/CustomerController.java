...
//    @PreAuthorize("hasRole('ADMIN')")
    ...
    @GetMapping("/{id}")
    public CustomerByIdDto getCustomerById(@PathVariable Integer id){
        System.out.println("Inside the get Customer");
...
//    @PreAuthorize("hasRole('ADMIN')")
    ...
    public ResponseEntity<CustomerByIdDto> updateCustomer(@PathVariable("customerId") int id,

                                                   @RequestBody CustomerByIdDto customerByIdDto) {

        CustomerByIdDto updatedCustomer = customerService.updateCustomer(id,customerByIdDto.getFirstName(),customerByIdDto.getLastName() , customerByIdDto.getPhoneNumber(), customerByIdDto.getEmail(), (short)customerByIdDto.getAge());
